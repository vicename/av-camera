...
public class FileOperateUtil {
    ...
    public final static int TYPE_DC = 4;
    public final static int TYPE_TEACHER = 5;
    public final static int TYPE_COMPOSED = 6;
    ...
    public static String getFolderPath(Context context, int type, String rootPath) {
        ...
        StringBuilder pathDC = new StringBuilder();
        String path = Environment.getExternalStorageDirectory().toString();
        Log.i("---", "FileOperateUtil--path0:" + path);
        pathDC.append(path);
        pathDC.append("/Pictures/av-camera");
...
//        return pathBuilder.toString();
     ...
     * @return 路径
     */
    public static String getFolderPathDC(String rootPath) {
        //本业务文件主目录
        StringBuilder path = new StringBuilder();
        String folder = Environment.getExternalStorageDirectory().toString();
        path.append(folder);
        path.append("/Pictures/av-camera");
    ...
    public static String getTempFolderPath(Context context, String rootPath) {
        ...
        StringBuilder pathBuilder = new StringBuilder();
        String path = Environment.getExternalStorageDirectory().toString();
        Log.i("---", "FileOperateUtil--path temp:" + path);
        //添加应用存储路径
        pathBuilder.append(context.getExternalFilesDir(null).getAbsolutePath());
        pathBuilder.append(File.separator);
        //添加文件总目录
